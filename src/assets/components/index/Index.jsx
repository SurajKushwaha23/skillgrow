        ...
        <div className='mx-auto max-w-7xl lg:px-8'>
          <div className='flex flex-col justify-center px-4 py-10 lg:px-6'>
            ...
            <p className='mt-8 max-w-full text-lg text-gray-700'>
              ...
              ea? Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia ipsam nulla
              aperiam quo possimus, nihil molestiae modi tenetur esse qui repudiandae cum fuga
              aspernatur ea?
            </p>
            <div className='mt-8'>
              <button
                type='button'
                className='inline-flex bg-blue-primary mx-2 py-2  px-5 bg-violet-500 text-white font-semibold rounded-full shadow-md hover:bg-blue-primary focus:outline-hidden focus:ring-3 focus:ring-violet-400 focus:ring-opacity-75'
              >
                Get started Today
