  ...
  return (
    <>
      <section className='bg-white'>
        <div className='mx-auto px-4 py-2 lg:flex lg:items-center'>
          <div className='mx-auto text-center'>
            ...
            <h1 className='text-4xl text-green-600 font-extrabold'>Congratulation.</h1>
      ...
      <div className=' py-8 bg-white flex flex-wrap justify-center gap-4'>
        <a
          className='inline-flex bg-blue-primary py-2  px-5 bg-violet-500 text-white text-sm font-semibold rounded-full shadow-md hover:bg-blue-primary focus:outline-hidden focus:ring-3 focus:ring-violet-400 focus:ring-opacity-75'
          href='#'
        >
